...
class CommonLeagueInfoAPIClient(MFLAPIClient):
    ...
    def get_rosters(cls, *, year: int, league_id: str, **kwargs) -> dict:
        ...
        """
        filters = [("TYPE", "rosters"), ("L", league_id), ("JSON", 1), ("INCLUDE_DRAFT_PICKS", 1)]
        ...
        cls._add_filter_if_given("FRANCHISE", franchise_id, filters)
    ...
    def get_future_draft_picks(cls, *, year: int, league_id: str) -> dict:
        """
        Get future draft picks for all franchises in a league.
        """
